...
在典型的向量数据库层面，没有技术栈限制的组织，可以灵活地选择新的向量数据库，如：Milvus、Qdrant 等，以支持 AI 模型的快速检索。而有技术栈限制的组织，
往往会结合过往的技术栈，如支持向量搜索的 ElasticSearch 版本，PostgreSQL + pgvector 等。

### 采用主流 AI 工具的技术

在另外一个方面，我们可以看到，国内的 AI 辅助编程工具，早先采用的都是和 GitHub Copilot 相似的技术栈、算法与交互方式等。甚至于诸多领先的 AI 辅助编码工具，
在代码分层、文件的命名和变量名都是一样的，
